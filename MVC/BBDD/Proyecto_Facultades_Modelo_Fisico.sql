...
CREATE TABLE `2000FACULTADES` (
	...
	2000descripcionfacultad TEXT NOT NULL,
	2000nomficherofotofacultad CHAR( 50 ) NOT NULL
)ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `2100CARRERAS` (
	...
	2100descripcioncarrera TEXT NOT NULL, 
	2100nomficherofotocarrera CHAR( 50 ) NOT NULL
)ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `10000USUARIOS` (
	10000idusuario MEDIUMINT UNSIGNED PRIMARY KEY AUTO_INCREMENT,
	10000nomusuario CHAR( 20 ) NOT NULL, 
	10000correousuario CHAR( 50 ) NOT NULL,
	10000contrasennausuario CHAR( 20 ) NOT NULL,
	UNIQUE ( 10000nomusuario ),
	UNIQUE ( 10000correousuario ),
	UNIQUE ( 10000contrasennausuario )
)ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
