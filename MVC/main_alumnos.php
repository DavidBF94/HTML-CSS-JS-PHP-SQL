...
<?php
	...
	/* main_alumnos
		...
		-- Descripcion larga --
			...
			En caso de no existir creamos una estructura para crear los botones "Registrarse" e "Iniciar Sesion". También incluye el archivo mod004 y obtiene de la función mod004_obtenerAlumnos el array con el código de error y la tabla con la información de los registros para, a continuación, incluir un archivo vista u otro en función de susodicho código de error.
		-- Argumentos --
			...
			$arTablaAlumnos						: Es el array respuesta de la función mod004_obtenerAlumnos, contiene el código de error y la tabla HTML para representar datos.
		...
		-- Archivos a los que llama --
			vista_main_alumnos / vista_error
		-- Autor --
	...
	*/
	...
	$arTablaAlumnos= mod004_obtenerAlumnos();
	
	if ( $arTablaAlumnos[ 0 ] !== "002" ) 
	{
		require ( "VISTA/vista_main_alumnos.php" );
	} 
	else 
	{
