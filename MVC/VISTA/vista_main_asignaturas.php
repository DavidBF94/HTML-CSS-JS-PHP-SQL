...
<html lang = "es">
	...
	<head>
		...
		<link rel = 'stylesheet' href='CSS/EstilosMainAsignaturas.css'>
		<link rel = 'stylesheet' href='CSS/EstilosTablasAsignaturas.css'>
		...
		<div class = 'main'>
			...
			<?php
				...
				echo "<div class = 'Submenu'>
						<a href='main_carreras.php?idfacultad=$idfacultad'>Volver</a>
					  </div>"
			?>
			...
			<?php
				...
				echo $arTablaDescripcionImagenCarrera[ 1 ];
