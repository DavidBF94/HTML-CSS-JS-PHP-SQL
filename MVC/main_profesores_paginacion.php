...
<?php
	...
	/* main_profesores_paginacion
		...
		-- Descripcion larga --
			...
			En caso de no existir creamos una estructura para crear los botones "Registrarse" e "Iniciar Sesion". También incluye el archivo mod004 y obtiene de la función mod004_obtenerProfesoresPaginacion el array con el código de error, la tabla con la información de los registros y la estructura para el menú de paginación para, a continuación, incluir un archivo vista u otro en función de susodicho código de error. En el propio enlace al controlador fijado en mod004_obtenerProfesoresPaginacion se incluye un número de página que recuperamos con $_GET y fijando un número de registros por página ya tenemos los dos argumentos a enviar a mod004_obtenerProfesoresPaginacion.
		-- Argumentos --
			...
			$arTablaProfesores					: Es el array respuesta de la función mod004_obtenerProfesoresPaginacion, contiene el código de error, la tabla HTML para representar datos y la estructura para el menú de paginación.
		-- Variables principales -- 
			...
			$datosError							: Es la variable que contiene el código de error de $arTablaProfesores.
		-- Archivos a los que llama --
			vista_main_profesores_paginacion / vista_error
		-- Autor --
	...
	*/
	...
	$arTablaProfesores = mod004_obtenerProfesoresPaginacion( $pag, $numRegistros );
	
	if ( $arTablaProfesores[ 0 ] !== "002" ) 
	{
		require ( "VISTA/vista_main_profesores_paginacion.php" );
	} 
	else 
	{
		$datosError = $arTablaProfesoress[ 1 ];
