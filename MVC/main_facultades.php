...
<?php
	...
	/* main_facultades
		...
		-- Descripcion larga --
			...
			En caso de no existir creamos una estructura para crear los botones "Registrarse" e "Iniciar Sesion". También incluye el archivo mod004 y obtiene de la función mod004_obtenerFacultades el array con el código de error y la tabla con la información de los registros para, a continuación, incluir un archivo vista u otro en función de susodicho código de error.
		-- Argumentos --
			...
			$arTablaFacultades					: Es el array respuesta de la función mod004_obtenerFacultades, contiene el código de error y la tabla HTML para representar datos.
		-- Variables principales -- 
			...
			$datosError							: Es la variable que contiene el código de error de $arTablaFacultades.
		-- Archivos a los que llama --
			vista_main_facultades / vista_error
		-- Autor --
	...
	*/
	...
	$arTablaFacultades = mod004_obtenerFacultades();
	
	if ( $arTablaFacultades[ 0 ] !== "002" ) 
	{
		require ( "VISTA/vista_main_facultades.php" );
	} 
	else 
	{
		$datosError = $arTablaFacultades[ 1 ];
