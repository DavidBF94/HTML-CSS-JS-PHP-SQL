...
<?php
	...
	/* main_profesores
		...
		-- Descripcion larga --
			...
			En caso de no existir creamos una estructura para crear los botones "Registrarse" e "Iniciar Sesion". También incluye el archivo mod004 y obtiene de la función mod004_obtenerProfesores el array con el código de error y la tabla con la información de los registros para, a continuación, incluir un archivo vista u otro en función de susodicho código de error.
		-- Argumentos --
			...
			$arTablaProfesores					: Es el array respuesta de la función mod004_obtenerProfesores, contiene el código de error y la tabla HTML para representar datos.
		...
		-- Archivos a los que llama --
			vista_main_profesores / vista_error
		-- Autor --
	...
	*/
	...
	$arTablaProfesores = mod004_obtenerProfesores();
	
	if ( $arTablaProfesores[ 0 ] !== "002" ) 
	{
		require ( "VISTA/vista_main_profesores.php" );
	} 
	else 
	{
